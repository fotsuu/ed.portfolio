...
- **Built-in Contact & Interactive Modals**: Functional contact interface with toast notifications and CV preview/download.
...
├── hnz-CV.pdf        # Downloadable curriculum vitae / resume
